...
var opcodes = [256]instruction{
	...
	0xB0: {"BCS", addrModeRelative, 2, 0, (*Cpu).branchIfCarrySet},
	0xB1: {"LDA", addrModeIndirIndexY, 2, 0, (*Cpu).loadA},
	...
	0xB9: {"LDA", addrModeAbsoluteY, 3, 0, (*Cpu).loadA},
	0xBA: {"TSX", addrModeImplied, 1, 2, (*Cpu).transferStackPointerToX},
	0xBC: {"LDY", addrModeAbsoluteX, 3, 0, (*Cpu).loadY},
	0xBD: {"LDA", addrModeAbsoluteX, 3, 0, (*Cpu).loadA},
	0xBE: {"LDX", addrModeAbsoluteY, 3, 0, (*Cpu).loadX},
